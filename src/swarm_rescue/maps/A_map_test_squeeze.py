...
Some parts of the file like map_test_squeeze are replaced when a map is generated
"""
...
from .A_walls_map_test_squeeze import add_walls, add_boxes


class MapTestSqueeze(MapAbstract):
    ...
    def __init__(self, zones_config: ZonesConfig = ()):
        ...
        # PARAMETERS MAP
        self._size_area = (777, 750)

        self._rescue_center = RescueCenter(size=(202,101))
        self._rescue_center_pos = ((274,306), 0)

        self._no_gps_zone = NoGpsZone(size=(400, 500))
        self._no_gps_zone_pos = ((-190, 0), 0)

        self._wounded_persons_pos = [(255,-226), (113,-169), (185,-163), (332,-162), (254,-160), (137,-66), (209,-59), (-345,65), (-348,205), (120,321)]
