...
Some parts of the file like *MAP_NAME* are replaced when a map is generated
"""
...
from .A_walls_*MAP_NAME* import add_walls, add_boxes


class *MAP_CLASS_NAME*(MapAbstract):
...
*RESCUE_CENTER_CODE*
        ...
        self._wounded_persons_pos = *WOUNDED_PERSONS_POS*
